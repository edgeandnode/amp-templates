# Fastify Backend with AMP Arrow Flight

A high-performance backend example built with Fastify that queries blockchain data via AMP's Arrow Flight interface for lightning-fast data access.
...
just start-backend            # Start Fastify backend
